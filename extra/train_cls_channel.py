...
from datasets import train_classification_data_4c, val_classification_data_4c
...
def main():
    ...
    model.features[0] = nn.Conv2d(4, first_conv_layer.out_channels, 
                                ...
                                stride=(2,2), 
                                padding=(1,1))
    model.classifier[1] = nn.Linear(model.classifier[1].in_features, NUM_CLASSES_CLS)
    ...
    model.features[0].apply(initialize_weights)
    ...
    trainloader = data.DataLoader(train_classification_data_4c(datadir, maskdir, train_csv, crop_size=(h,w)),
    ...
    valloader = data.DataLoader(val_classification_data_4c(valdir, maskdir, val_csv, crop_size=(h,w)), batch_size=1, shuffle=False,
                                num_workers=8,
                                pin_memory=True)
