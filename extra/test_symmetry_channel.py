...
from datasets import val_symmetry_data_4c  # Assuming you have a similar test dataset loader as your train/val

# Load your test dataset
datadir = '../../data/SymDerm_v2/SymDerm_extended/'
maskdir = '../../data/SymDerm_v2/SymDerm_binary_mask'

test_csv = 'data_files/SymDerm_v2_test.csv'  # Update with your test CSV file path
MODEL_PATH = 'models/SymmetryNet_squeezenet_4c_trial4/symmetry_net_ep49.pth'
testloader = DataLoader(val_symmetry_data_4c(datadir, maskdir, test_csv), batch_size=1, shuffle=False, num_workers=8, pin_memory=True)
