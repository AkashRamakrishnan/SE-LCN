...
def find_efficientnet_layer(arch, target_layer_name):
    """Find efficientnet layer to calculate GradCAM.
    ...
    """
    # Access the features submodule specific to EfficientNet implementation
    for name, module in arch.named_modules():
        if name == target_layer_name:
            return module
    raise ValueError(f"No layer named {target_layer_name} found in EfficientNet.")
